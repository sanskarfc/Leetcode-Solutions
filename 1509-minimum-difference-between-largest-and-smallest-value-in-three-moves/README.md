...
<p>Return <em>the<span class="highlighter--highlighted" data-highlight-id="0" style="background-color: rgb(255, 246, 21); color: inherit;"> minimum difference between the largest and smallest value</span> of <code>nums</code> after performing <strong>at most three moves</strong></em>.</p>
